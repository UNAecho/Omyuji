    ...
    while True:
        ...
        if headportrait_of_main_account_coordinate.__len__() > 0:
            ...
            start_battle_button_is_availeable_coordinate = \
                identifyImg.identify_find_template_or_not(start_battle_button_is_availeable_filename, 0.85)
...
def catch_invite_main_account_error(chapter):
    ...
    identifyImg.look_for_template_to_click("breakthrough_union_close.png", 1, 0.75)
    identifyImg.look_for_template_to_click("breakthrough_union_close.png", 1, 0.75)
