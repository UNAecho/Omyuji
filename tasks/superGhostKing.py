...
while True:
    ...
    if whether_tiaozhan_buttion.__len__() > 0:
        ...
        if 0 <= physical_power <= 90:
            identifyImg.identify_template_click("D:\\omyuji_ico\\tuizhi_superGhost_King.png", 0.8)
            fight()
        else:
            time.sleep(300)
    else:
        identifyImg.identify_template_click("D:\\omyuji_ico\\back_button_blue.png", 0.7)
    time.sleep(5)
