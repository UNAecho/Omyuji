...
def choose_reward_by_time():
    ...
    reward_invite_coordinate = identifyImage.identify_find_template_or_not(reward_invite_filename, 0.75)
    if reward_invite_coordinate.__len__() > 0:

        reward_refuse_filename = "reward_refuse.png"
        reward_refuse_coordinate = identifyImage.identify_find_template_or_not(reward_refuse_filename,0.95)
